...
<ul>
  <li>well i got my own wayland compositor(but basically just smithay) and WM (the wm's name is flux) , and im currently working on it now , whan im done ....... no i think i wont put ts shit in public </li>
...
<h3> OH AND ALSO FUCK NVIDIA</h3>
<table border="0" cellpadding="0" cellspacing="0" style="border: none; background: transparent; width: 100%;">
  <tr style="border: none; background: transparent;">
    <!--  -->
    <td valign="top" style="border: none; padding: 0 20px 0 0; width: 50%;">
<pre style="line-height: 0.95; font-family: monospace; font-size: 13px; background: transparent; border: none; white-space: pre; margin: 0;">
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣠⣤⣤⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣾⣿⣿⣿⣿⣿⣿⣷⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⣸⣿⣿⣿⣿⣿⣿⣿⣿⣿⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⣽⢫⡌⣿⣿⢉⣤⠹⣿⣿⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
⠀⠀⠀⠀⠀⠉⠙⠻⠿⠛⠁⠀⠀⠀⠀⠀⠀⠀⠈⠻⠷⠿⠋⠀⠀⠀⠀
    ...
    <!-- -->
    <td valign="middle" style="border: none; padding: 0; width: 50%;">
<pre style="line-height: 1.2; font-family: monospace; font-size: 14px; background: transparent; border: none; white-space: pre; margin: 0;">
 _____ _   _ _____ _____   ____   ___  _   _ 
|_   _| | | |  ___|  ___| / ___| / _ \| \ | |
  | | | | | | |_  | |_    \___ \| | | |  \| |
  | | | |_| |  _| |  _|    ___) | |_| | |\  |
